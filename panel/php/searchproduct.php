...
if(isset($_GET['by'])){$method = $_GET['by'];}else{$method = '';}
extract($_POST);
?>
<!DOCTYPE html>
<html lang="en">
   ...
   <head>
      ...
      <!-- site metas -->
      <title>Search Product &#8211; Store Inventory Manager</title>
   ...
   <body class="dashboard dashboard_1">
                        ...
                        <div class="white_shd full margin_bottom_30">
                           <div class="full graph_head">
                              <div class="heading1 margin_0">
                                 <h2 class="text-capitalize">Search By <?php if($method == 'qr') {echo "<span class='text-uppercase'>".$method."</span>"; } else { echo $method; } ?><small></small></h2>
                              </div>
                           </div>
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div id="table" class="table-responsive-sm">
                                       <table class="table table-striped text-center text-capitalize projects">
                                          ...
                                          <?php
                                           if($method == 'name'){
                                            if(isset($_POST['submit'])){
                                              ...
                                              $products = "SELECT * FROM products WHERE ProductName LIKE ('".$ProductName."%')";
                                          ...
                                          ?>
                                             ...
                                             <td><?php echo $array['ProductID']; ?></td>
                                                ...
                                                <td>
                                                 <?php 
                                                  ...
                                                  while($ar = mysqli_fetch_array($r)){echo $ar['ProductQuantity'];}
                                                 ?>
                                                </td>
                                                <td>
                                                <?php 
                                                ...
                                                <td title="View Product Invoice"><span style="cursor:pointer;" onclick="invoice(<?php echo $array['id']; ?>);"><i class="fa fa-eye fa-lg"></i></span></td>
                                             </tr>
                                             <?php
                                                } 
                                               }
                                           ...
                                           if($method == 'id'){
                                            if(isset($_POST['submit'])){
                                              $ProductID = $_POST['id'];
                                              $products = "SELECT * FROM products WHERE ProductID LIKE ('".$ProductID."%')";
                                          ...
                                          <?php
                                           if($method == 'serial'){
                                            if(isset($_POST['submit'])){
                                              $ProductSerialNo = $_POST['serial'];
                                              $products = "SELECT * FROM products WHERE ProductSerialNo LIKE ('".$ProductSerialNo."%')";
                                          ...
                                          ?>
                                           ...
                                           <?php
                                            if(isset($_GET['data'])){
                                              ...
                                              $products = "SELECT * FROM products WHERE ProductName LIKE ('".$qr."%')";
                                          ...
                                          ?>
                                             ...
                                             <?php
                                                   ...
                                                   echo "<script>location.href='../qr/qr-reader/index.php?searchqr=scan';</script>";
                                                }
                                               }
                                             ?>
                                          </tbody>
                                       ...
                                       <script>
                                          function invoice(id){ var id = id; window.open('../viewstock/php/purchase-invoice.php?id=' + id, '_blank', 'location=yes,height=570,width=1080,scrollbars=yes,status=yes'); }
                                       </script>
                                    </div>
                                 </div>
                              </div>
      ...
      <script type="text/javascript">
         function logout() {
            ...
            if(massage == true){ window.location.replace('./logout.php') }
         }
      </script>
      <?php
      if($method == 'qr'){
