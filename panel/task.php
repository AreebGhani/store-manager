...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
            ...
            <div id="content">
                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="./php/badgenotification.php?pg=task"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="./php/badgemail.php?pg=task"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                        ...
                        <div class="white_shd full margin_bottom_30">
                           <div class="full graph_head">
                              <div class="heading1 margin_0">
                                 <h2>All Tasks <span data-bs-toggle="modal" data-bs-target="#task" class="btn btn-success" style="border:solid 1px;border-radius:25px;padding:5px;padding-left:14px;padding-right:14px;margin-left:10px;"><a style="font-size:20px;font-weight:900;"> <i class="fa fa-plus"></i> </a></span></h2>
                              </div>
                                  ...
                                  <div class="mail-box">
                                   <aside class="lg-side">
                                    ...
                                    <table class="table table-inbox text-center text-capitalize">
                                       <thead>
                                         <tr>
                                            <td style="font-weight:900;" class="view-message dont-show"><strong>Time</strong></td>
                                            <td style="font-weight:900;" class="view-message"><strong> From </strong></td>
                                            <td style="font-weight:900;" class="view-message"><strong> Tasks </strong></td>
                                            <td style="width:5%;"></td>
                                            <td style="width:5%;"></td>
                                         </tr>
                                       </thead>
                                       <tbdoy>
                                        ...
                                        while($arraytask = mysqli_fetch_array($result)){
                                        ?>
                                        <tr>
                                            <td class="view-message text-uppercase"><?php echo "🕛 ".$arraytask['Time']." <br> 📅 ".$arraytask['Date']; ?></td>
                                            <td class="view-message dont-show"><?php echo $arraytask['Names']; ?></td>
                                            <td class="view-message"><?php echo $arraytask['Tasks']; ?></td>
                                            <td class="view-message"><?php if($arraytask['Names'] == $_SESSION['Name']){ echo "<button type='button' class='btn btnedit' data-bs-toggle='modal' data-bs-target='#updatetask'> <i class='fa fa-edit fa-lg'></i> </button>"; } ?>  </td>
                                            <td class="view-message"><?php if($arraytask['Names'] == $_SESSION['Name']){ echo "<button class='btn btnclose' onclick='Delete(".$arraytask['id'].")'> <i class='fa fa-trash fa-lg'></i> </button>"; } ?> </td>
                                         </tr>
                                        <?php
                                         }
                                        ?>  
                ...
                <div class="modal-dialog">
                  <div class="modal-content">    
                    ...
                    <div class="modal-body">
                        <div class="m-auto">
                           <form id="form1" action="./php/taskpage.php" method="post">
              ...
              <div class="modal fade" id="updatetask" tabindex="-1" aria-labelledby="updatetaskLabel" aria-hidden="true">          
                <div class="modal-dialog">
                  <div class="modal-content">    
                     <div class="modal-header">
                        <h5 class="modal-title" id="updatetaskLabel"><strong>Update Your Task</strong></h5>
                        <div><button type="button" class="btn btnclose" data-bs-dismiss="modal" aria-label="Close"><i class="fa fa-close fa-lg"></i></button></div>
                    </div>     
                    <div class="modal-body">
                        <div class="m-auto">
                           <form id="form2" action="./php/task_update.php" method="post">
                               <?php
                               $Name = $_SESSION['Name'];
                               $query = "SELECT * FROM task WHERE Names = '$Name'";
                               $get = mysqli_query($connect, $query);
                               while($arrayupdatetask = mysqli_fetch_array($get)){
                               ?>
                                 <input value="<?php echo $arrayupdatetask['Tasks']; ?>" class="task form-control" type="text" name="task" placeholder="Write Something . . ." required></input>
                               <?php
                                 }
                               ?> 
                                 <br>
                                 <button type="submit" name="submit" class="main_bt">Update Task</button>
                           </form>
                        </div>
                     </div>
                  </div>
      ...
      <script>
         ...
         function Delete(id){
            var id = id;
            var massage = confirm('Do You Want To Delete Your Task . . . ?');
            if(massage == true){
               window.location.replace('./php/task_del.php?id=' + id);
            }
         } 
         function findmail() {
