...
$sel = "SELECT SUM((ProductQuantity * PurchasePrice)) FROM products";
$sql = mysqli_query($connect, $sel);
while($a=mysqli_fetch_array($sql)){
    $invest = $a[0];
}
$empty3 = "TRUNCATE TABLE reportcache";
$erase = mysqli_query($connect, $empty3);
if($erase){
    $connect2 = mysqli_connect($server, $user, $password);
    $r = mysqli_query($connect2,"SHOW DATABASES");
    while ($row = mysqli_fetch_array($r)){
        $db = $row[0];
        $connect3 = mysqli_connect($server, $user, $password,$db);
        $searchtable = mysqli_query($connect3,"SHOW TABLES");
        while($table = mysqli_fetch_array($searchtable)){
            $tb = $table[0];
            $sel2 = "SELECT payment FROM ".$tb."";
            $sql2 = mysqli_query($connect3, $sel2);
            if($sql2){
               $num=1;
                $a2=mysqli_fetch_array($sql2);
                $payment = $a2[0];
                if($payment == 'None'){echo $payment;}else{
                  $sel3 = "SELECT SUM(subtotal) FROM ".$tb."";
                  $sql3 = mysqli_query($connect3, $sel3);
                 if($sql3){
                     $a3=mysqli_fetch_array($sql3);
                     $total = $a3[0];
                     $in = "INSERT INTO reportcache (No, Total) VALUES ('$num','$total')";
                     $inserted = mysqli_query($connect, $in);
                    }
                }
                $num++;
            }
    ...
    if(isset($inserted)){
        $q = "SELECT SUM(Total) FROM reportcache";
...
<html lang="en">
   ...
   <head>
      ...
      <!-- site metas -->
      <title>Reports &#8211; Store Inventory Manager</title>
            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        <a href="./report.php"><i class="fa fa-object-group blue2_color"></i><span>Inventory Report</span></a>
                     </li>
                     <li>
                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgenotification.php?pg=report"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgemail.php?pg=report"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                       ...
                       <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no"> <?php if(isset($invest)){if(isset($totalsales)){ if($totalsales-$invest > 0){echo "On Profit";}else{echo "On Loss";} }else{echo "None";} }else{echo "None";} ?></p>
                                    <p class="head_couter font-weight-bold">Store Status</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-dollar blue1_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">Rs.<?php if(isset($invest)){ if($invest == ''){ echo "0"; }else{ echo $invest; } }else{echo "0";} ?></p>
                                    <p class="head_couter font-weight-bold">Total Invest</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              <div class="couter_icon">
                                 <div> 
                                    <i class="fa fa-bank green_color"></i>
                                 </div>
                              </div>
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no">Rs.<?php if(isset($totalsales)){ echo $totalsales; }else{echo "0";} ?></p>
                                    <p class="head_couter font-weight-bold">Total Sales</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="total_no"><?php $select = "SELECT * FROM users"; $result = mysqli_query($connect, $select); $Rows = mysqli_num_rows($result); echo $Rows; ?></p>
                                    ...
                                    <div class="col-md-12">
                                       <div class="content">
                                          <div class="area_chart table-responsive-sm">
                                           <table class="table table-bordered text-center text-capitalize projects">
                                             <thead class="thead-light">
                                             <tr>
                                                <th class="font-weight-bold">Name</th>
                                                <th class="font-weight-bold">Item Buyed</th>
                                                <th class="font-weight-bold">Item Sold</th>
                                                <th class="font-weight-bold">Item Left</th>
                                                <th class="font-weight-bold">Invest</th>
                                                <th class="font-weight-bold">Gain</th>
                                          ...
                                          ?>
                                             <tr>
                                                ...
                                                <td>
                                                 <?php 
                                                  $id = $array['ProductID'];
                                                  $q = "select ProductQuantity from soldproducts where ProductID = '$id'";
                                                  $r = mysqli_query($connect, $q);
                                                  while($ar = mysqli_fetch_array($r)){ $soldprod = $ar['ProductQuantity']; echo $ar['ProductQuantity'];}
                                                 ?>
                                                </td>
                                                <td>
                                                <?php 
                                                ...
                                                <td>Rs.<?php $invest2 = $array['PurchasePrice']*$array['ProductQuantity']; echo $invest2; ?></td>
                                                <td>Rs.<?php if(isset($soldprod)){ $gain = $array['SalePrice']*$soldprod; echo $gain; } ?></td>
                                                <td><?php if(isset($gain)){if(isset($invest2)){ if($gain-$invest2 >0){echo "profit";}else{echo "loss";} }} ?></td>
                                                <td>
                                                ...
                                                <td class="text-uppercase"><?php echo $array['Date']."<br>".$array['Time']; ?></td>
                                             </tr>
                                             <?php
                                              }
                                             ?>
