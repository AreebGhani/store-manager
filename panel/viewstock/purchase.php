...
<html lang="en">
   ...
   <head>
      ...
      <!-- site metas -->
      <title>View Stock &#8211; Store Inventory Manager</title>
   ...
   <body class="dashboard dashboard_1">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="stock">
                           <li><a href="./avaliable.php"><span>Avaliable</span></a></li>
                           ...
                           <li><a href="./damage.php"><span>Damage</span></a></li>
                        </ul>
                     </li>
                     <li>
                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgenotification.php?pg=viewpurchase"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgemail.php?pg=viewpurchase"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                        ...
                        <div class="white_shd full margin_bottom_30">
                           <div class="full graph_head">
                              <div class="heading1 margin_0">
                                 <h2>Purchased Products<small></small></h2>
                              </div>
                                       ...
                                       <table class="table table-striped text-center text-capitalize projects">
                                          ...
                                          ?>
                                             <tr>
                                                ...
                                                <td style="font-weight:900;" class="text-uppercase text-danger"><?php if($array['MarkAs'] == ""){echo "none";}else{echo $array['MarkAs'];} ?></td>
                                             </tr>
                                             <?php
                                              }
                                             ?>
      ...
      <script type="text/javascript">
         ...
         function invoice(id){
            var id = id;
            window.open('./php/purchase-invoice.php?id=' + id, '_blank', 'location=yes,height=570,width=1080,scrollbars=yes,status=yes');
         }
         function findmail() {
