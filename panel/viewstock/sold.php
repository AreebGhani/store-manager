                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgenotification.php?pg=viewsold"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgemail.php?pg=viewsold"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                        ...
                        <div class="white_shd full margin_bottom_30">
                           <div class="full graph_head">
                              <div class="heading1 margin_0">
                                 <h2>Solded Products<small></small></h2>
                              </div>
