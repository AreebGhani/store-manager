...
<html lang="en">
   ...
   <head>
      ...
      <!-- site metas -->
      <title>Invoice &#8211; Store Inventory Manager</title>
    ...
    <body>
                           ...
                           <div class="white_shd full margin_bottom_30">
                             <div class="full graph_head">
                               <div class="heading1 margin_0" style="display:inline-flex;">
                                  ...
                                  <h5 class="ml-2 mr-2"> <span class="btnprint" onclick="Print(<?php echo $array['id']; ?>);">Print <i class="fa fa-print"></i></span></h5> <h2>|</h2> 
                                  <span class="ml-2"><span onclick="window.close('', '_parent', '');" class="btnclose"><i class="fa fa-close"></i></span></span>
                               </div>
                              </div>
                              <div id="printDiv">
                              <div class="full">
      ...
      <script>
         ...
         function Print(id){
            var id = id;
            window.open('./print-invoice.php?id=' + id, '_blank', 'location=yes,height=570,width=1080,scrollbars=yes,status=yes');
