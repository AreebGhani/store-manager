                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="./php/badgenotification.php?pg=profile"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="./php/badgemail.php?pg=profile"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="full dis_flex center_text">
                                        <?php 
                                         $Name = $_SESSION['Name'];
                                         $select = "SELECT * FROM users WHERE Names = '$Name'";
                                         $result = mysqli_query($connect, $select);                                                       
                                                   ...
                                                   <div class="tab-pane fade show active" id="recent_activity" role="tabpanel" aria-labelledby="nav-home-tab">
                                                    <div class="msg_list_main">
                                                      <ul class="msg_list">
                                                         ...
                                                         $new_id = $get_id - 3 ;
                                                         if($get_id <= 3){
                                                            $select = "SELECT * FROM conversation WHERE Names = '$Name'";
                                                            $result = mysqli_query($connect, $select);                             
                                                          ...
                                                          <?php
                                                            ...
                                                            $select = "SELECT * FROM conversation WHERE Names = '$Name' AND id > '$new_id'";
                                                            $result = mysqli_query($connect, $select);                             
                                                            while($array2 = mysqli_fetch_array($result)){
                                                           ?>
                                                          <li>
