   ...
   <body class="dashboard dashboard_1">
                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgenotification.php?pg=removereturn"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgemail.php?pg=removereturn"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
      ...
      <script type="text/javascript">
         ...
         function del(id){
            ...
            if(massage == true){ window.location.replace('./php/return.php?id='+id); }
         }
         function findmail() {
