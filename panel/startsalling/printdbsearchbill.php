...
$result3 = mysqli_query($connect3, $cust);
...
$data = "SELECT * FROM ".$searchname."";
$result = mysqli_query($connect3, $data);
    ...
    <body>
      ...
      <script>
          $(document).ready(function(){
            window.print();
            setTimeout(function () {
	         	window.location.replace('./bill.php?data=billprintedfromdbsearch');
      	    }, 10);
          });
      </script>
   </body>
