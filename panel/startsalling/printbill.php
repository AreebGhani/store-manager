...
$server2 = "localhost";$user2 = "root";$password2 = "";$database2 = $custna;
$connect2 = mysqli_connect($server2, $user2, $password2, $database2);
$billno = $_SESSION['billno'];
$data = "SELECT * FROM ".$custna.$billno."";
...
$result2 = mysqli_query($connect, $prod);
while($prodarray = mysqli_fetch_array($result2)){
 $ProductName = $prodarray['pna'];
 $ProductQuantity = $prodarray['pqty'];
 $SalePrice = $prodarray['ppr'];
 $Tax = $prodarray['ptx'];
 $pid = $prodarray['pid'];
 $products = "SELECT * FROM purchaseproducts WHERE ProductID = '$pid'";
 $result = mysqli_query($connect, $products);
    ...
    <body>
                        ...
                        <div class="full bg-transparent margin_bottom_30">
                           ...
                           <div class="full price_table bg-transparent padding_infor_info">
                              <div class="row bg-transparent">
                                 ...
                                 <?php $customers = "SELECT * FROM custcache";
                                  $result = mysqli_query($connect, $customers);                                           
                                  while($cust = mysqli_fetch_array($result)){?>
                                 <br>
                                  <div class="container">
                                       <p style="margin-bottom:-3px;" class="col-12"><span style="font-weight:600;">Bill Number : </span> <span><?php echo $_SESSION['billno']; ?></span></p>
                                       <p style="margin-bottom:-2px;" class="col-12"><span style="font-weight:600;">Customer Name : </span> <span class="text-capitalize"><?php echo $cust['custna']; ?></span></p>
                                       <p style="margin-bottom:-2px;" class="col-12"><span style="font-weight:600;">Customer Address : </span> <span class="text-capitalize"><?php echo $cust['custad']; ?></span></p>
                                       <p style="margin:;" class="col-12"><span style="font-weight:600;">Customer Contact No. : </span> <span class="text-capitalize"><?php echo $cust['custcno']; ?></span></p>
                                        <?php } ?>
                                  </div>
                                    ...
                                    <div class="table-responsive-sm bg-transparent">
                                       <table id="products" class="table text-center bg-transparent text-capitalize projects">
                                          ...
                                          <tbody class="bg-transparent">
                                             <?php $products = "SELECT * FROM prodcache";
                                               $result = mysqli_query($connect, $products);                       
      ...
      <script>
          $(document).ready(function(){
            window.print();
            setTimeout(function () {
	         	window.location.replace('./bill.php?data=billprinted');
      	    }, 10);
          });
      </script>
   </body>
