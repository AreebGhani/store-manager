   ...
   <body class="dashboard dashboard_1">
               ...
               <div class="sidebar_blog_2">
                  <h4>Product Detail:</h4>
                   <div class="container row col-lg-12 mt-3">
                    ...
                    <br>
                    <form id="prod" action="./billcache.php?data=productfromsearch" method="POST" class="container row col-lg-12 mt-3">
                                 ...
                                 <hr style="border:2px dotted gray;">
                                  <div class="row">
                                     ...
                                     <?php
                                       ...
                                       <p style="margin-top:-4px;margin-bottom:-4px;">Customer Name : <span class="text-capitalize"><?php echo $custna; ?></span><b class="btn" data-bs-toggle="modal" data-bs-target="#custborrow" type="submit"><span class="bg-light p-1" style="font-size:12px;font-weight:bold;">Check Customer Remaining</span></b></p>
                ...
                <div class="modal-dialog">
                  <div class="modal-content bg-dark">    
                    ...
                    <div class="modal-body">
                        <div class="m-auto">
                          <form id="editdetail" action="./billcache.php?data=editdetailfromsearch" method="POST">
                              <table id="products" class="table table-striped text-center text-capitalize projects">
                                 <thead class="thead-dark">
                                   <tr>
                                     <th>Name</th>
                                 ...
                                 <tbody>
                                  <?php 
                                   if(isset($_GET['id'])){
                                    $id = $_GET['id'];
                                    $products = "SELECT * FROM ".$searchname." WHERE id = '$id'";
                                    $result = mysqli_query($connect, $products);                 
                                    while($prod = mysqli_fetch_array($result)){ ?>
                                    <tr id="tr">
                    ...
                    <div class="modal-body">
                        <div class="m-auto">
                          <form id="printform" action="./billcache.php" method="GET">
                             <input name="data" value="printbillfromsearch" hidden>
                             <div class="row">
                                <div class="col-lg-6">
                                  <h4 class="text-white text-uppercase">Total :</h4>
                                  <span class="d-inline-flex"><span class="rs pl-2 pr-2 pt-2">Rs. </span>
                                  <input name="totalamount" id="totalamount" required class="form-control" value="<?php $query = "SELECT SUM(subtotal) FROM ".$searchname."";$sql = mysqli_query($connect, $query);$row = mysqli_fetch_array($sql);$sum = $row[0];$_SESSION['total'] = $sum;echo $sum; ?>" readonly>
                                  </span>
      ...
      <script>
         function checkstock(){
          ...
          function save(){
            location.replace('./billcache.php?data=savebillfromsearch');
          }
          function printbill(){
            $('#printmodal').click();
          }
      ...
      <script>
         ...
         function remove(id){
            ...
            if(massage == true){
               window.location.replace('./billcache.php?data=deletefromsearch&&id=' + id);
            }
         }
         function edit(id){
            var id = id;
            location.replace("./getsearchbill.php?billcache=cust&&billcache2=prod&&total=true&&billcache3=billno&&id="+id+"#products");
            setTimeout(function(){
               location.reload();
               },100);
         }
         ...
         <?php if(isset($_GET['billcache4'])){
            echo "$(document).ready(function(){
               window.location.replace('./printsearchbill.php');
            });
            "; 
            } ?>
      </script>
