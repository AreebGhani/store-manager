...
<html lang="en">
   ...
   <head>
      ...
      <!-- site metas -->
      <title>Add User &#8211; Store Inventory Manager</title>
                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgenotification.php?pg=additionalinsertuser"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgemail.php?pg=additionalinsertuser"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                        ...
                        <div class="white_shd full margin_bottom_30">
                           <div class="full graph_head">
                              <div class="heading1 margin_0">
                                 <h2>Create Account<small></small></h2>
                              </div>
                           </div>
                           <div class="full price_table padding_infor_info">
                              <div class="row">
                                 <form id="form" action="./adduser.php" method="POST" enctype="multipart/form-data" class="col-lg-12">
                                     <div class="container row">
                                     <div class="col-lg-5 m-1">
                                         <label>User Name:</label>
                                         <?php if(isset($_GET['id'])){echo '<input name="id" value="'.$_GET['id'].'" hidden >';} ?>
                                         <?php if(isset($_GET['pg'])){echo '<input name="pg" value="'.$_GET['pg'].'" hidden >';} ?>
                                         <input name="name" value="<?php if(isset($_GET['n'])){echo $_GET['n'];} ?>" type="text" maxlength="20" placeholder="Enter User Name" class="form-control" title="Enter Name Of The User Which You Want To Get Access To Store Inventory Manager" required>
                                     </div>
                                     <div class="col-lg-5 m-1">
                                        <label>Email:</label>
                                        <input name="email" value="<?php if(isset($_GET['e'])){echo $_GET['e'];} ?>" type="email" placeholder="Enter User Email Address" required class="form-control" title="Enter Email Address Of The User Which You Want To Get Access To Store Inventory Manager">
                                     </div>
                                     <div class="col-lg-5 m-1" title="Enter Product Serial No.">
                                        <label>Password:</label>
                                        <input name="password" type="text" placeholder="Enter User Password" required class="form-control" title="Create Custom Password Of The User Which You Want To Get Access To Store Inventory Manager">
                                     </div>
                                     <div class="col-lg-5 m-1">
                                         <label>Address:</label>
                                         <input name="address" type="text" placeholder="Enter User Address" class="form-control" title="Enter Address Of The User Which You Want To Get Access To Store Inventory Manager" required>
                                     </div>
                                     <div class="col-lg-5 m-1">
                                         <label>About:</label>
                                         <input name="about" type="text" placeholder="Write About Some User" class="form-control" title="Write About Some User Which You Want To Get Access To Store Inventory Manager" required>
                                     </div>
                                     <div class="col-lg-5 m-1">
                                       <label>Phone No:</label>
                                       <div class=""><input name="phone" type="text" pattern="[0-9]{11}" value="+92<?php if(isset($_GET['c'])){echo '0'.$_GET['c'];} ?>" id="phone" required placeholder="Enter User Contact No." class="form-control mb-2" title="Enter Phone No# Of The User Which You Want To Get Access To Store Inventory Manager"></div>
                                     </div>
                                     <div class="col-lg-5 m-1">
                                        <label>Photo:</label>
                                     ...
                                     <div class="col-lg-5 m-1">
                                        <button class="main_bt mt-5" type="submit" id="submit" name="submit">Add User</button>
                                     </div>
                                    </form>
                              </div>
                           </div>
