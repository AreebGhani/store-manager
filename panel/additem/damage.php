...
<html lang="en">
   ...
   <body class="dashboard dashboard_1">
                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgenotification.php?pg=adddamage"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="../php/badgemail.php?pg=adddamage"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                        ...
                        <div class="white_shd full margin_bottom_30">
                           <div class="full graph_head">
                              <div class="heading1 margin_0">
                                 <h2>Damage Products<small></small></h2>
                              </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="table-responsive-sm">
                                       <table class="table table-striped text-center text-capitalize projects">
                                          ...
                                          <tbody>
                                          <?php
                                           $products = "SELECT * FROM purchaseproducts WHERE MarkAs = ''";
                                          ...
                                          ?>
                                             <tr>
                                                ...
                                                <td><button onclick="damage(<?php echo $array['ProductID']; ?>);" class="btn btn-outline-danger"><b>Damage</b></button></td>
                                             </tr>
                                             <?php
                                              }
                                             ?>
      ...
      <script type="text/javascript">
         ...
         function damage(id){
            var id = id;
            var massage = confirm('Mark This Product As Damage . . . ?');
            if(massage == true){ window.location.replace('./php/damage.php?id='+id) }
         }
         function findmail() {
