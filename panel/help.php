...
<html lang="en">
   ...
   <head>
      ...
      <!-- site metas -->
      <title>Help &#8211; Store Inventory Manager</title>
   ...
   <body class="dashboard dashboard_1">
                                ...
                                <?php 
                                 ...
                                 <li id="bell" class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="./php/badgenotification.php?pg=help"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php
                                 ...
                                 <li class="notification none">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="./php/badgemail.php?pg=help"><span style="font-weight:bold;">Mark As Read</span></a>
                                      <?php 
                        ...
                        <div class="white_shd full margin_bottom_30">
                           <div class="full graph_head">
                              <div class="heading1 margin_0">
                                 <h2>Contact With  <small>. . .</small></h2>
                              </div>
                           </div>
                           <div class="map_section padding_infor_info">
                              <div class="map m_style1">
                                 <div id="map">
                                    <!-- column contact --> 
                                    <div style="margin-top:-25px;" class="profile_details margin_bottom_30">
                                        <div class="contact_blog">
                                           <h4 class="brief">Site Developed By :</h4>
                                           <div class="contact_inner">
                                              <div class="left">
                                                 <h3>Areeb Ghani</h3>
                                                 <p><strong>About: </strong>Full Stack Web Developer</p>
                                                 <ul class="list-unstyled">
                                                    <li><i class="fa fa-envelope-o"></i> : areebghanidps@gmail.com</li>
                                                    <li><i class="fa fa-phone"></i> : +92 304 1554698</li>
                                                 </ul>
                                              </div>
                                              <div class="bottom_list">
                                                 <div class="left_rating">
                                                    <p class="ratings">
                                                       <a onclick="star1()" style="cursor:pointer;"><span id="str1" class="fa fa-star-o"></span></a>
                                                       <a onclick="star2()" style="cursor:pointer;"><span id="str2" class="fa fa-star-o"></span></a>
                                                       <a onclick="star3()" style="cursor:pointer;"><span id="str3" class="fa fa-star-o"></span></a>
                                                       <a onclick="star4()" style="cursor:pointer;"><span id="str4" class="fa fa-star-o"></span></a>
                                                       <a onclick="star5()" style="cursor:pointer;"><span id="str5" class="fa fa-star-o"></span></a>
                                                    </p>
                                                 </div>
                                                 <div class="right_button view">
                                                    <button type="button" class="btn btn-success btn-xs"> 
                                                       <a href="mailto:areebghanidps@gmail.com" class="text-white">Mail <i class="fa fa-comments-o"></i></a>
                                                    </button>
                                                    <button type="button" class="btn btn-primary btn-xs">
                                                       <a href="tel:+923041554698" class="text-white">Call <i class="fa fa-phone"></i></a>
                                                    </button>
                                                 </div>
                                              </div>
                                           </div>
      ...
      <script type="text/javascript">
         ...
         function star1(){
            $('#str1').removeClass("fa-star-o");$('#str1').addClass("fa-star");
         }
         function star2(){
            $('#str2').removeClass("fa-star-o");$('#str2').addClass("fa-star");
         }
         function star3(){
            $('#str3').removeClass("fa-star-o");$('#str3').addClass("fa-star");
         }
         function star4(){
            $('#str4').removeClass("fa-star-o");$('#str4').addClass("fa-star");
         }
         function star5(){
            $('#str5').removeClass("fa-star-o");$('#str5').addClass("fa-star");
         }
      </script>
   </body>
   <!-- Store Inventory Manager, Created By Areeb Ghani, Friday - 26 Nov 2021 15:41:54 GMT -->
